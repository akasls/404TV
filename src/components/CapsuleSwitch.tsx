      ...
      {options.map((opt, index) => {
        ...
        return (
          <button
            ...
            className={`relative z-10 w-16 px-3 py-1 text-xs sm:w-20 sm:py-2 sm:text-sm rounded-full font-medium transition-all duration-200 cursor-pointer whitespace-nowrap ${
              isActive
